        ...
        <div>
            <div className='bg-[url(https://user-images.githubusercontent.com/106715328/196274688-9ed1ce2b-1c68-4998-a448-75553ca991ef.jpg)] min-h-screen w-full bg-cover bg-center p-1'>
                ...
                <div className="grid grid-cols-3 gap-1 pl-8 pr-8">
                    <div className="pt-6 pr-1 pl-6 pb-32 bg-slate-200 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-6 ml-auto mr-auto h-5/6 w-8/12">
                        <div>
                    ...
                    <div className="pt-6 pr-1 pl-6 pb-32 bg-slate-200 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-6 ml-auto mr-auto h-5/6 w-8/12">
                        <div>
                            <img src={wanderlust} alt="" className="h-5/6 w-11/12 pl-3 rounded-lg"/>
                        </div>
                        <br/>
                    ...
                    <div className="pt-6 pr-1 pl-6 pb-32 bg-slate-200 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-6 ml-auto mr-auto h-5/6 w-8/12">
                        <div>
                            <img src={beer} alt="" className="h-5/6 w-11/12 pl-3 rounded-lg"/>
                        </div>
                        <br/>
                    ...
                    <div className="pt-6 pr-1 pl-6 pb-32 bg-slate-200 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-6 ml-auto mr-auto h-5/6 w-8/12">
                        <div>
                            <img src={coders} alt="" className="h-5/6 w-11/12 pl-3 rounded-lg"/>
                        </div>
                        <br/>
                    ...
                    <div className="pt-6 pr-1 pl-6 pb-32 bg-slate-200 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-6 ml-auto mr-auto h-5/6 w-8/12">
                        <div>
                            <img src={destiny} alt="" className="h-5/6 w-11/12 pl-3 rounded-lg"/>
                        </div>
                        <br/>
